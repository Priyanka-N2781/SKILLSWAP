...
import { Search, Briefcase, ArrowUpRight, GraduationCap } from "lucide-react";
...
export default function HomePage() {
  ...
  // Filter skills: Exclude current user's own skills
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="sticky top-0 z-10 bg-background/80 backdrop-blur-md pb-4 md:hidden">
         <div className="flex items-center justify-between mb-6">
           <div>
             ...
             <p className="text-sm text-muted-foreground">Find students to teach you.</p>
           </div>
         </div>
      ...
      <div className="hidden md:flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-display font-bold">Discover Skills</h1>
          <p className="text-muted-foreground">Find fellow students to teach you.</p>
        </div>
      </div>
      ...
      <Dialog open={!!selectedSkill} onOpenChange={(o) => !o && setSelectedSkill(null)}>
        <DialogContent className="rounded-3xl p-6 sm:max-w-md">
           ...
           <div className="py-4">
             <Textarea 
               placeholder="Hi! I'd love to learn this from you. What can I teach you in exchange?" 
